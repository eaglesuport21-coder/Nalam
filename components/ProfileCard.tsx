        ...
        <div className="pt-2 grid grid-cols-2 gap-3 relative">
          ...
          <div className="relative group/btn">
            ...
            <button 
              ...
              className={`w-full font-black py-3 rounded-2xl text-xs transition-all flex items-center justify-center space-x-1 ${
                profile.isVerified 
                ? 'bg-gradient-to-r from-rose-800 to-rose-700 text-amber-400 shadow-[0_4px_14px_0_rgba(153,27,27,0.39)] hover:shadow-[0_6px_20px_rgba(153,27,27,0.23)] border-b-4 border-rose-950 active:scale-95' 
                : 'bg-rose-800 text-amber-400 shadow-lg shadow-rose-200 hover:bg-rose-900 border-b-2 border-rose-950 active:scale-95'
              }`}
            >
              {profile.isVerified && (
